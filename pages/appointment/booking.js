                  ...
                  <div className="bookCalendar d-flex align-items-center">
                    <figure className="book">
                      <Image
                        src={Images.bookImg}
                        alt=""
                        className="img-fluid bookiImg me-2 "
                      />
                    </figure>
                    <h6 className="fontEighteen  me-4">Bookings</h6>
                  </div>
                  ...
                  <div className="appointmenMonth">
                    <div className="monthBack">
                      <Image
                        ...
                        alt="leftarrow"
                        className="img-fluid leftIcon"
                      />
                      <span className="monthText">October 2023</span>
                      <Image
                        src={Images.rightArrowPos}
                        alt="calendarimage"
                        className="img-fluid rightIcon"
                      />
                    </div>
                  </div>
                ...
                <div className="bookingRight d-flex align-items-center">
                  ...
                  <div className="seacrhBox me-3">
                    <Image
                      ...
                      alt="blueSearch"
                      className="img-fluid  blueSearch me-2"
                    />
                    <div class="bookingsearchBar">
                      <input
                        type="text"
                        class="form-control searchControlbook"
                        placeholder=""
                      />
                    </div>
                  </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <ListGroup className="navtabs">
                <ListGroupItem className="tabsappointment">
