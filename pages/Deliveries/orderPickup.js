...
const OrderPickup = () => {
    return (
        <>
            {/* <div className='orderPickupSection deliverySection'>
                <div className='deliverMain w-100'>
                    <div className='row '>
                        <div className='col-lg-6'>
                            <div className='assignLeft deliveryOuter me-0'>
                                <div className='flexTable'>
                                    <Image src={Images.boldLeftArrow} alt="boldLeftArrow image " className="img-fluid me-2" />
                                    <h4 className='loginMain text-start m-0'>Orders Picked Up</h4>
                                </div>
            ...
            <div className='orderPickupSection deliverMapSection'>
                <Image src={Images.map} alt="map Image" className="mapImg" />
