              ...
              <div className="deliverOrderLeft deliveryOuter me-0">
                <div className="flexTable">
                  ...
                  <h4 className="loginMain text-start m-0">
                    Shipping{" "}
                    {orderListType?.title === "Returned"
                      ? "Order Returns"
                      : orderListType?.title === "Shipped"
                      ? "Tracking Orders"
                      : orderListType?.title}
                  </h4>
                </div>
                {orderListType?.status != 0 &&
                  orderListType?.status != 7 &&
                  orderListType?.status != 8 && (
                ...
                {loading1 ? (
                  ...
                  <div className="table-responsive mt-3">
                    <table
                      id={
                        orderListType?.title === "Order to Review"
                          ? "ordersToReview"
                          : orderListType?.title === "Order Accepted"
                          ? "acceptedOrders"
                          : orderListType?.title === "Order Prepared"
                          ? "acceptedPrepared"
                          : orderListType?.title === "Printing Label"
                          ? "printingLabel"
                          : orderListType?.title === "Shipped"
                          ? "shippedOrders"
                          : orderListType?.title === "Rejected/Cancelled"
                          ? "rejectOrder"
                          : orderListType?.title === "Returned"
                          ? "returnedOrder"
                          : ""
                      ...
                      ? singleOrderData?.order_details?.map((v, i) => {
                          return (
                            <div key={i} className="selectedProductDetails">
                              ...
                              <p className="productPriceinvoice dataSpace">
                                ${v?.price}
                              </p>
                              <p className="productPriceinvoice dataSpace">
                                {v?.qty}
                    ...
                    <div className="col-lg-4">
                      <div className="OrderBox p-0">
                        ...
                        <div className="OrderCheckoutBox">
                          ...
                          <p className="orderSubHeading">
                            {moment
                              .utc(singleOrderData?.created_at)
                              .format("MM/DD/YYYY")}
                          </p>
                        </div>
                        <div className="OrderCheckoutBox">
                        ...
                        <div className="OrderTotal">
                          ...
                          {singleOrderData?.status === 0 ? (
                            ...
                            <button
                              type="button "
                              disabled
                              className="pickupBtn w-100 mt-2  justify-content-center"
                            >
                              Rejected
                            </button>
