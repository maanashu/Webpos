        ...
        <div className="innerViewContainer">
                ...
                <Accordion.Header className="accordnHead">
                  <div className="flexDiv w-100 mainAccordn">
                    ...
                    <h4 className="accordnText">
                      USD {sessionSummary?.cash_in?.total ? amountFormat(sessionSummary.cash_in.total) : '$0.00'}
                    </h4>
                  </div>
                </Accordion.Header>
                <Accordion.Body>
                        ...
                        <Accordion.Header>
                          <div className="flexDiv w-100 subAccordn">
                            ...
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.sales?.total ? amountFormat(sessionSummary.cash_in.sales.total) : '$0.00'}
                            </h4>
                          </div>
                        </Accordion.Header>
                        <Accordion.Body>
                          <div className="flexDiv mt-2 py-1">
                            ...
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.sales?.cash ? amountFormat(sessionSummary.cash_in.sales.cash) : '$0.00'}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Card</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.sales?.card ? amountFormat(sessionSummary.cash_in.sales.card) : '$0.00'}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Jobr Coin</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.sales?.jobr_coin ? amountFormat(sessionSummary.cash_in.sales.jobr_coin) : '$0.00'}
                            </h4>
                          </div>
                        </Accordion.Body>
                      </Accordion.Item>
                      ...
                      <Accordion.Item eventKey="0">
                        <Accordion.Header>
                          <div className="flexDiv w-100 subAccordn">
                            ...
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.manual?.total ? amountFormat(sessionSummary.cash_in.manual.total) : '$0.00'}
                            </h4>
                          </div>
                        </Accordion.Header>
                        <Accordion.Body>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Cash</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.manual?.cash ? amountFormat(sessionSummary.cash_in.manual.cash) : "$0.00"}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Card</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.manual?.card ? amountFormat(sessionSummary.cash_in.manual.card) : "$0.00"}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Jobr Coin</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_in?.manual?.jobr_coin ? amountFormat(sessionSummary.cash_in.manual.jobr_coin) : "$0.00"}
                            </h4>
                          </div>
                        </Accordion.Body>
                      </Accordion.Item>
                      ...
                      <Accordion.Item eventKey="0">
                        <Accordion.Header>
                          <div className="flexDiv w-100 subAccordn">
                            ...
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.refund?.total ? amountFormat(sessionSummary.cash_out.refund.total) : "$0.00"}
                            </h4>
                          </div>
                        </Accordion.Header>
                        <Accordion.Body>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Cash</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.refund?.cash ? amountFormat(sessionSummary.cash_out.refund.cash) : "$0.00"}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Card</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.refund?.card ? amountFormat(sessionSummary.cash_out.refund.card) : "$0.00"}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Jobr Coin</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.refund?.jobr_coin ? amountFormat(sessionSummary.cash_out.refund.jobr_coin) : "$0.00"}
                            </h4>
                          </div>
                        </Accordion.Body>
                      </Accordion.Item>
                      ...
                      <Accordion.Item eventKey="0">
                        <Accordion.Header>
                          <div className="flexDiv w-100 subAccordn">
                            <h4 className="appointSub m-0">Manual</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.manual?.total ? amountFormat(sessionSummary.cash_out.manual.total) : "$0.00"}
                            </h4>
                          </div>
                        </Accordion.Header>
                        <Accordion.Body>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Cash</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.manual?.cash ? amountFormat(sessionSummary.cash_out.manual.cash) : "$0.00"}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Card</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.manual?.card ? amountFormat(sessionSummary.cash_out.manual.card) : "$0.00"}
                            </h4>
                          </div>
                          <div className="flexDiv mt-2 py-1">
                            <h4 className="appointSub m-0 ps-3">Jobr Coin</h4>
                            <h4 className="appointSub m-0">
                              USD {sessionSummary?.cash_out?.manual?.jobr_coin ? amountFormat(sessionSummary.cash_out.manual.jobr_coin) : "$0.00"}
                            </h4>
                          </div>
                        </Accordion.Body>
                      </Accordion.Item>
          ...
          <div className="netPaymentView">
            ...
            <h1 className="totalAmmount w-100" style={{textAlign: "right"}}>
              USD {sessionSummary?.net_amount ? amountFormat(sessionSummary.net_amount) : "$0.00"}
            </h1>
          </div>
          <button
            type="button"
