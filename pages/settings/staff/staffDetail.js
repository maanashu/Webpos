        ...
        <div className="settingOuter staffDetailRight">
          ...
          <div className="staffInfoBox">
            ...
            <div className="staffProfileData">
              <div className="flexDiv">
                ...
                <h4 className="appointSub m-0">
                  {" "}
                  {moment(getStaffInfo?.pos_staff_detail?.created_at).format(
                    "ll"
                  )}
                </h4>
              </div>
          ...
          <div className="staffTimeSection mt-3">
            ...
            <div className="staffSubTime">
              ...
              <hr className="staffTimeDivide" />
              <h4 className="appointSub m-0">
                {getStaffInfo?.pos_staff_detail?.current_billing_cycle?.start ??
                  "__"}{" "}
                -{" "}
                {getStaffInfo?.pos_staff_detail?.current_billing_cycle?.end ||
                  "__"}
              </h4>
            </div>
            {/* )
            ...
            <div className="staffSubTime">
              ...
              <hr className="staffTimeDivide" />
              <h4 className="appointSub m-0">
                JBR {getStaffInfo?.pos_staff_detail?.time_tracked ?? "__"} /h
              </h4>
            </div>
            <div className="staffSubTime">
              ...
              <hr className="staffTimeDivide" />
              <h4 className="appointSub m-0">
                {getStaffInfo?.pos_staff_detail?.weekly_time_tracking_limit ??
                  "__"}
              </h4>
            </div>
          </div>
                  ...
                  return (
                    <div key={index} className="staffTableOuter">
                      <div className="staffTableData">
                        ...
                        <div className="staffBoxData ">
                          <h4 className="staffTableText">
                            {convertMinutesToHoursAndMinutes(data?.duration)}
                          </h4>
                        </div>
                        <div className="staffBoxData">
                          <h4 className="staffTableText">
                        ...
                        <div className="staffBoxData ">
                          <button
                            className={
                              data?.status === 2 ? "paidBtn " : "unpaidBtn"
                            }
                            type="button"
                          >
                        ...
                        <div className="staffBoxData">
                          <button
                            className={
                              data?.status === 2 ? "viewBtn " : "requestBtn"
                            }
                            onClick={() =>
                              handleRequest(
                                data?.status,
