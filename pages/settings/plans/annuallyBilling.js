            ...
            <div className='col-lg-4 mt-4'>
                <div className='bussinessEnter'>
                    <div className='professionEnterSub'>
                        ...
                        <h4 className='settingText my-2'>Apps included:</h4>
                        <div className='planTickBox'>
                            <Image src={Images.bussinessCheck} alt="cyanCircleTick image" className="img-fluid" />
                            <Image src={Images.blueCircleTick} alt="blueCircleTick image" className="img-fluid" />
                        ...
                        <div className='planTickBox'>
                            <Image src={Images.bussinessCheck} alt="lightCircleTick image" className="img-fluid" />
                    ...
                    <button className='changeBtn'>
                        Change
                        <Image src={Images.ArrowRight} alt="lightCircleTick image" className="img-fluid ms-1" />
                    </button>
                </div>
            </div>
            <div className='col-lg-4 mt-4'>
                <div className='professionEnter'>
                    <div className='professionEnterSub'>
                        ...
                        <h4 className='settingText my-2'>Apps included:</h4>
                        <div className='planTickBox'>
                            <Image src={Images.fillCheck} alt="cyanCircleTick image" className="img-fluid" />
                            <Image src={Images.blueCircleTick} alt="blueCircleTick image" className="img-fluid" />
                        ...
                        <div className='planTickBox'>
                            <Image src={Images.fillCheck} alt="lightCircleTick image" className="img-fluid" />
...
export default AnnuallyBilling