      ...
      const data =
        modalType == "add"
          ? {
            ...
            amount: drawerSessionDetail?.drawer_activites?.length == 0 || drawerSessionDetail?.drawer_activites?.length > 0 && drawerSessionDetail?.drawer_activites[0]?.mode_of_cash === 'cash_out' ? (Number(drawerSessionDetail?.opening_balance) + Number(addCashInput)) : parseFloat(addCashInput),
